...
DDPM_CKPT = '/kaggle/input/datasets/rajafaisalishfaq/final-checkpoint/ddpm_final.pt'
...
if __name__ == '__main__':
    ...
    for rnd in range(start_round, FL_CFG['global_rounds']):
        ...
        avg_model, kd_losses = server_knowledge_distillation(
            ...
            KD_CFG, fid_weights=None, device=DEVICE
        )
